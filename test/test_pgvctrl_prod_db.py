...
class TestPgvctrlProdDb:
    def setup_method(self, test_method):
        ...
        rtn = pgv.run(["-init", PROD_FLG, "-repo", TestUtil.pgvctrl_test_repo, "-d", TestUtil.pgvctrl_test_db], retcode=0)
    ...
    def test_chkver(self):
        ...
        assert rtn[TestUtil.stdout] == '0.0.gettingStarted: {0} PRODUCTION\n'.format(TestUtil.pgvctrl_test_repo)
    ...
    def test_apply_fast_forward(self):
        ...
        arg_list = ["-applyff", good_ff, PROD_FLG, "-repo", TestUtil.pgvctrl_test_repo, "-d", TestUtil.pgvctrl_test_db]
